import{r as y,g as s,e as o,f as t,i as C,a0 as c,t as r,F as v,j as h,n as g}from"./index-B6GtFO2S.js";const b={class:"guidecontent"},N={class:"guidetitle"},x=["onClick"],S=["onClick"],P={__name:"example2",props:{sampleProps:{type:Object,default:()=>{}}},setup(u){const n=y({className:"",codeSample:[{title:"HTML",sampleCodeJS:`<ListTable 
    :selected="true"
    :downLoad="true"
...
const onChangedPage = (num) => {
    ...
    //api호출
    getNoticeList();
};`}]}),m=a=>{const e=document.getElementsByClassName("codewrap");e[a].classList.contains("up")?e[a].classList.remove("up"):e[a].classList.add("up")},p=a=>{navigator.clipboard.writeText(a).then(()=>{alert("코드가 클립보드에 복사되었습니다.")}).catch(e=>{console.error("클립보드 복사 실패:",e),alert("클립보드 복사에 실패했습니다.")})};return(a,e)=>{var d;return o(),s("div",b,[t("div",N,[c(r((d=u.sampleProps)==null?void 0:d.title)+" ",1),t("button",{type:"button",class:"btn-sample",onClick:e[0]||(e[0]=l=>a.goToPage("/boxlayout"))},"샘플페이지 보기")]),e[2]||(e[2]=C('<div class="guidememo"><div class="memotitle">리스트 테이블(ag-grid)</div><ul class="memolist"><li><strong class="tagstyle">selected: </strong>페이징 처리를 위한 셀렉트 박스 사용 여부 default: false</li><li><strong class="tagstyle">download:</strong> 파일 다운로드 버튼 사용 여부 default: false</li><li><strong class="tagstyle">downParams:</strong> 파일 다운로드 파라미터 객체 default: {}</li><li><strong class="tagstyle">rowData:</strong> 테이블 데이터 객체 default: []</li><li><strong class="tagstyle">totalCnt:</strong> 총 데이터 개수 default: 0</li><li><strong class="tagstyle">columnDefs:</strong> 테이블 컬럼 정의 객체 default: []</li><li><strong class="tagstyle">defaultColDef:</strong> 테이블 컬럼 기본 정의 객체 default: {}</li><li><strong class="tagstyle">domLayout:</strong> 테이블 레이아웃 타입 default: &#39;autoHeight&#39;</li><li><strong class="tagstyle">cntPerPage:</strong> 페이지당 데이터 개수 default: 10</li><li><strong class="tagstyle">itemCount:</strong> 총 데이터 개수 default: 0</li><li><strong class="tagstyle">currentPage:</strong> 현재 페이지 번호 default: 1</li><li><strong class="tagstyle">onChangedPage:</strong> 페이지 변경 이벤트 함수 default: () =&gt; {}</li><li>테이블내에 커스텀이 필요한 경우 cellRenderer 함수를 사용하여 이벤트까지 처리 할 수 있음</li></ul></div>',1)),(o(!0),s(v,null,h(n.codeSample,(l,i)=>(o(),s("div",{class:"codewrap",key:i},[t("div",{class:g(["codetitle",n.className])},[t("span",{onClick:f=>m(i)},r(l.title),9,x),t("button",{type:"button",class:"btn btn-ss",onClick:f=>p(l.sampleCodeJS)},e[1]||(e[1]=[t("span",{class:"ico-menu"},null,-1),c(" 복사하기")]),8,S)],2),t("div",{class:g(["code",l.title])},[t("pre",null,[t("code",null,r(l.sampleCodeJS),1)])],2)]))),128))])}}};export{P as default};
