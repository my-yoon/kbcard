<template>
    ...
    <SearchBox @onSearchResult="onSearchResult" @onReload="onReload">
        <template #formItem>
            ...
            <div class="item">
                <label>키워드 검색</label>
                <div class="input">
                    <div class="dv"><input type="text" class="form-control" placeholder="키워드를 검색 하세요"
    ...
    <ListTable :selected="true" :downLoad="true" :rowData="state.rowData" :totalCnt="pager.totalCnt"
        ...
        :regbuttonName="'생성'" :deletebuttonName="'삭제'" @changedPage="onChangedPage" @onRegister="onRegister"
        @onDelete="onDelete" />
    <div class="ui-dragdrop-menu full mt-10">
        <ul class="ui-dragdrop-list">
            ...
            <li class="ui-dragdrop-item active">
                <div class="ui-dragdrop-item-top10"><span class="num">2</span><span
                        class="ui-tag bc2">DE1561</span><span class="subject">챌린지는 무엇인가요?</span></div>
            </li>
            <li class="ui-dragdrop-item">
                <div class="ui-dragdrop-item-top10"><span class="num">3</span><span
                        class="ui-tag bc2">DE1562</span><span class="subject">제목입니다.</span></div>
            </li>
            <li class="ui-dragdrop-item">
                <div class="ui-dragdrop-item-top10"><span class="num">4</span><span
                        class="ui-tag bc2">DE1563</span><span class="subject">제목입니다.</span></div>
            </li>
            <li class="ui-dragdrop-item">
                <div class="ui-dragdrop-item-top10"><span class="num">5</span><span
                        class="ui-tag bc2">DE1564</span><span class="subject">제목입니다.</span></div>
            </li>
            <li class="ui-dragdrop-item">
                <div class="ui-dragdrop-item-top10"><span class="num">6</span><span
                        class="ui-tag bc2">DE1565</span><span class="subject">제목입니다.</span></div>
            </li>
        </ul>
    </div>
    <div class="ui-chips">
    ...
    <span class="checkbox"><input id="isImportant" name="isImportantGroup" type="checkbox"><label
            for="isImportant">중요내용변경
            여부(30일 전 사전공지가 필요합니다.)</label></span>
    <div class="ui-editor">
    ...
    <div style="background-color: #f7f7f7; text-align: center;">
        <ChartPie ref="chartpieRef" :data-sets="state.chartPie.datasets" :labels="state.chartPie.label"
            :options="state.chartPie.options"></ChartPie>
    </div>
    <div style="background-color: #f7f7f7; text-align: center; margin-top:20px">
        <ChartBar ref="chartbarRef" :data-sets="state.chartBar.datasets" :labels="state.chartBar.label"
            :options="state.chartBar.options"></ChartBar>
    </div>
    <div style="background-color: #f7f7f7; text-align: center;margin-top:20px">
        <ChartBubble ref="chartbubbleRef" :data-sets="state.chartBubble.datasets" :labels="state.chartBubble.label"
            :options="state.chartBubble.options"></ChartBubble>
    </div>
    <div style="background-color: #f7f7f7; text-align: center;margin-top:20px">
        <ChartLine ref="chartlineRef" :data-sets="state.chartLine.datasets" :labels="state.chartLine.label"
            :options="state.chartLine.options"></ChartLine>
    </div>
                ...
                <div class="ui-bar-x">
                    ...
                    <ul class="ui-bar-x-unit">
                        <li v-for="(item, index) in state.salesStat" :key="index">
                            ...
                            <span class="x-value">{{ state.salesStatStandard === 'day' ? dayJS(item.date).format('D') :
        dayJS(item.date).format('M') }}</span>
                        </li>
                    </ul>
                </div>
    ...
    <default-modal :is-show="state.modalType" :modal-title="'알림'" :button-confirm="'확인'" :button-cancel="'취소'"
        :modal-name="'modalAlert'" @modalclose="modalClose">
