...
const state = reactive({
    menulist: [
        ...
        { label: '데이터 피커', value: 'example4', component: 'example4', props: {title: '데이터 피커'} },
        { label: '에디터(CKEditor)', value: 'example5', component: 'example5', props: {title: '에디터'} },
        { label: '폼(validate)', value: 'example6', component: 'example6', props: {title: '폼(validate)'} },
    ],
})
